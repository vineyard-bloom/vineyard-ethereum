...
export class GethNode {
  ...
  start() {
    ...
    // const childProcess = this.childProcess = child_process.exec('geth --datadir=~/myBlockchain/node1 --networkid 100 --identity node1 --rpc --rpcport 8545 --rpcapi=\"db,eth,net,web3,personal,web3\" --keystore ./keystores console')
      ...
      const childProcess2 = this.childProcess2 = child_process.exec('geth --datadir=~/myBlockchain/node3 --port "30302" --networkid 100 --verbosity 4 --identity node3 --rpc --rpcport 8546 --rpcapi=\"db,eth,net,web3,personal,web3\" --keystore ./keystores console')
