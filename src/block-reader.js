...
var EthereumBlockReader = /** @class */ (function () {
    function EthereumBlockReader(web3) {
        this.web3 = web3;
    }
    EthereumBlockReader.prototype.getHeighestBlockIndex = function () {
        return client_functions_1.getBlockIndex(this.web3);
    };
    EthereumBlockReader.prototype.getBlockInfo = function (index) {
        return __awaiter(this, void 0, void 0, function () {
            var block;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, client_functions_1.getBlock(this.web3, index)];
                    case 1:
                        block = _a.sent();
    ...
    EthereumBlockReader.prototype.getFullBlock = function (blockIndex) {
        return client_functions_1.getFullBlock(this.web3, blockIndex);
    };
    EthereumBlockReader.prototype.getBlockTransactions = function (blockIndex) {
        return __awaiter(this, void 0, void 0, function () {
            var block;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, client_functions_1.getFullBlock(this.web3, blockIndex)];
                    case 1:
                        block = _a.sent();
                        return [2 /*return*/, block
                                ? block.transactions
    ...
    // }
    EthereumBlockReader.createFromConfig = function (config) {
