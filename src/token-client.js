...
class TokenClient {
    ...
    getNextBlockInfo(previousBlock) {
        return __awaiter(this, void 0, void 0, function* () {
            return client_functions_1.getNextBlockInfo(this.web3, previousBlock);
        });
    }
    getFullBlock(blockInfo) {
        return __awaiter(this, void 0, void 0, function* () {
            return client_functions_1.getFullBlock(this.web3, blockInfo.index);
        });
    }
    getBlock(blockIndex) {
        return __awaiter(this, void 0, void 0, function* () {
